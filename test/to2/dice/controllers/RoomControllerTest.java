...
import to2.dice.controllers.poker.PokerGameStrategy;
...
public class RoomControllerTest {
    ...
    private PokerGameStrategy pokerGameStrategy;
    ...
    public void setUp() throws Exception {
        ...
        pokerGameStrategy = new PokerGameStrategy(settings, state);

        gameController = new AbstractGameController(server, settings, "Andrzej") {
            @Override
        ...
        gameController.initialize(state, pokerGameStrategy);

        roomController = new RoomController(gameController, settings, state, pokerGameStrategy);
    ...
    @Test
    public void testAddHumanPlayer() throws Exception {
        String playerName = "Wojciech";
        roomController.addHumanPlayer(playerName);
    ...
    public void testIsPlayerWithName() throws Exception {
        ...
        roomController.addHumanPlayer(firstPlayerName);
        ...
        roomController.addHumanPlayer(secondPlayerName);
    ...
    public void testIsRoomFull() throws Exception {
        ...
        for (int i = 0; i < settings.getMaxPlayers(); i++) {
            roomController.addHumanPlayer(Integer.toString(i));
    ...
    public void testIsGameStarted() throws Exception {
        ...
        assertTrue("Game with maximum players number is not started", roomController.isGameStarted());
    }
